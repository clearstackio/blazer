module Blazer
  class ChecksController < BaseController
    ...
    def create
      ...
      if @check.save
        redirect_to query_path(@check.query), notice: "Check created successfully."
      else
        render_errors @check
      end
    end
    ...
    def update
      if @check.update(check_params)
        redirect_to query_path(@check.query), notice: "Check updated successfully."
      else
        render_errors @check
      end
    end
    ...
    def destroy
      @check.destroy
      redirect_to checks_path, notice: "Check deleted successfully."
    end
